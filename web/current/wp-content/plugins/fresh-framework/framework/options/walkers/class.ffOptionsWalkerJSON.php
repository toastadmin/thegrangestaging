...
abstract class ffOptionsWalkerJSON extends ffBasicObject {
/******************************************************************************/
...
/******************************************************************************/
    ...
    public function setOptionsHolder( $optionsHolder ) {
...
/******************************************************************************/
	...
	protected function _getOptionsStructure() {
        ...
        if( $this->_optionsStructure == null && $this->_optionsHolder != null ) {
            $this->_optionsStructure = $this->_optionsHolder->getOptions();
        }
    ...
    /**
     * @param null $optionsHolder
     */
    protected function _setOptionsHolder($optionsHolder)
    {
