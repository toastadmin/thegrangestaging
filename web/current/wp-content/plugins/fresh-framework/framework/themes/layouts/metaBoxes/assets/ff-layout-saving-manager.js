...
/**********************************************************************************************************************/
        $(document).on('click', '#ff-layout-save-ajax', function() {
            ...
            var $placementForm = $('#LayoutPlacement .ff-metabox-normalize-options');
             ...
             var normalizedContentForm = frslib.options.template.functions.normalizeFast( $contentForm );

            var $normalizedContentForm = frslib.options.template.functions.normalizeFast( $contentForm, true, false );
            var $normalizedConditionsForm = frslib.options.template.functions.normalizeFast( $conditionsForm, true, false );
            var $normalizedPlacementForm = frslib.options.template.functions.normalizeFast( $placementForm, true, false );




            console.log( normalizedContentForm );
