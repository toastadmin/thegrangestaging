...
/**********************************************************************************************************************/
        walker.setCallbackBeforeRepeatableVariationContainer(function( item, id, index ){
            ...
            _.output += '<li class="ff-repeatable-item ff-repeatable-item-js ff-repeatable-item-'+index+' ff-repeatable-item-closed" data-section-id="'+item.id+'" data-section-name="'+sectionName+'" data-node-id="'+index+'" data-current-name-route="'+nameRoute+'" data-current-section-route="'+currentSectionRoute+'">';
            ...
            _.output += '<table class="ff-repeatable-header-table"><tbody><tr>';
                ...
                if(_.getItemParam(item, 'show-advanced-tools') == true) {
                    _.output += '<div class="ff-show-advanced-tools dashicons dashicons-admin-tools"></div>';
                }
...
/**********************************************************************************************************************/
        walker.setCallbackBeforeRepeatableVariableContainer(function(item, id ){
            ...
            //console.log(_.getItemParam(item, 'class') );
            //console.log("--------" );
