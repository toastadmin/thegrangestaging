    ...
    frslib.options.functions.initOneOptionSet = function( $optionsJSWrapper, doNotMakeAnimation ) {
        ...
        $optionsJSWrapper.find('.ff-all-items-opened').each(function(){
            ...
            $(this).children('li').each(function(){
                ...
                $(this).addClass('ff-repeatable-item-opened');
        ...
        if( printCopyAndPaste == true ) {
            ...
            //$(document).on('click', '.ff-onepage-copy-to-clipboard', function(){
            //
            //    var data = {};
            //
...
$(document).on('click', '.ff-repeatable-copy', function(){
    ...
    $item4.find('.ff-popup-open').removeClass('ff-popup-open');

    $item4.find('[data-value]').each(function(){
...
$(document).on('click', '.ff-repeatable-paste', function(){
    ...
    console.log( $item.attr('data-current-section-route'), $parent.attr('data-current-section-route') );
...
frslib.options.template.functions.normalizeFast = function( $form, returnForm, deleteOriginalForm, ignoreDefaultValues ) {
        ...
        //if( )
            ...
            $f.find('.ff-repeatable, .ff-repeatable-item, input[name], select[name], textarea[name]').each(function(){
                ...
                if( $(this).hasClass('ff-repeatable') ) {
                    ...
                    //console.log( 'plus plus: ' + currentLevel+ '  ---  ' + counters[currentLevel ]);
                    currentLevel = $(this).parent().attr('data-current-level');
                    counters[currentLevel ] ++;

                    //var route = $(this).attr('data-current-section-route').split(' ');
                    ...
                    //setDataPointer( route, {} );
                    }



                    // select 2
                    if( $(this).hasClass('ff-select2') ) {
